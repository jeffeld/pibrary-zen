...
function formatDate (v) {
    ...
    var m = moment(v);
    return m.format('MMMM Do YYYY, HH:mm');
...
exports.Password_Reset_Request = function (mi) {

    mi.requestDate = formatDate(mi.created);

    send ('password/password-reset.jade', mi, 'Library password reset request');
};
