...
//    });
    ...
    app.get ('/api/members/activations', membersapi.GetPendingActivations);
    app.delete ('/api/members/activations/:email', membersapi.DeletePendingActivation);

    app.get ('/api/member/:dbid', membersapi.GetByDbId);
    app.put ('/api/member/:dbid', membersapi.Activate);

    app.get ('/api/member/:membershipcode/photo', membersapi.GetMemberPhoto);
