var config = require ('../config/config'),
    ...
    db = mongojs(config.database, ['members', 'resets']),
...
exports.AddMember = function (mi, success, failure) {
    ...
    // We need to assign a temporary membership code here (as represented by the guid)
    // to satisfy the needs of the unique index on membershipCode
    newMember.membershipCode = util.generateUUID();
