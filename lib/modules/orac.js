...
exports.LendItem = function (stockCode, membershipCode, success, failure) {
    putOracCall ('lend/' + stockCode + '/' + membershipCode, success, failure);
};
...
exports.GetStockCodes = function (quantity, spatial, success, failure) {
    var path = ['stock/codes/', quantity, '/', spatial].join('');
